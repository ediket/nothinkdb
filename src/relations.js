...
export function hasOne(link) {
  ...
  return { join, link, sync, TargetTable: left.table, type: 'hasOne' };
}
...
export function belongsTo(link) {
  ...
  return { join, link, sync, TargetTable: right.table, type: 'belongsTo' };
}
...
export function hasMany(link) {
  ...
  return { join, create, remove, link, sync, TargetTable: left.table, type: 'hasMany' };
}
...
export function belongsToMany(link) {
  ...
  return { join, create, remove, link, sync, TargetTable: link2.right.table, type: 'belongsToMany' };
}
